...
<h1 style="text-align: center; color: white;">Pending Reimbursements</h1>
<div style = "background-color: #59b9ff; border-radius: 10px;">
<table id="pending_reimbursement_table" style = "text-color: white;" >
		<thead>
			<tr>
				<th>ID</th>
				<th>Amount</th>
...
$(document).ready( function () {
    $('#pending_reimbursement_table').DataTable();
} );
</script>
</body>
</html>